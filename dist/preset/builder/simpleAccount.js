...
class SimpleAccount extends builder_1.UserOperationBuilder {
    ...
    static init(signer, rpcUrl, opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            base.useMiddleware((0, middleware_1.neroPaymaster)());
            base.useMiddleware((0, middleware_1.estimateUserOperationGas)(base.provider));
            return base.useMiddleware((0, middleware_1.signUserOpHash)(base.signer));
        });
    }
