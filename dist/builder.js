...
class UserOperationBuilder {
    ...
    setPaymasterOptions(obj) {
        this.paymasterOptions = Object.assign(Object.assign({}, this.paymasterOptions), obj);
    }
    resolveFields(op) {
        const obj = {
    ...
    buildOp(entryPoint, chainId, stateOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const ctx = new context_1.UserOperationMiddlewareCtx(this.currOp, entryPoint, chainId, this.paymasterOptions, stateOverrides);
